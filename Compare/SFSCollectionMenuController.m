...
- (void)setBackgroundViewForCollectionWithImage:(UIImage *)image {
    if (!_collectionViewBackgroundImageView) {
        UIColor *bottomColor = [UIColor colorWithRed:186.0f/255.0f green:168.0/255.0 blue:169.0f/255.0f alpha:1.0];
        UIImage *imagebottom= [self createImageWithColor:bottomColor];

        _collectionViewBackgroundImageView = [[UIImageView alloc] initWithImage:imagebottom];
    } else {
